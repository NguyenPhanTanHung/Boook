        ...
        <View>
          ...
          <View className="mt-5">
            <ScrollView className="h-36 ">
              <Text className="text-gray-500 text-xs text-justify">{product?.title}</Text>
            </ScrollView>
          </View>
        </View>
      </View>
      <View className="absolute bottom-5 left-0 w-full px-4">
        <View className="flex-row justify-between items-center mt-10">
          <View >
            ...
            <Text className="font-bold text-lg">{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product?.price)}</Text>
          </View>
